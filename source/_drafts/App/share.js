...
<!-- app下载 -->
<div class="appD">
    <a class="appOff" href="javascript:;"></a>
    <img class="appLogo" src="http://v2.jingqubao.com/apps/w3g/_static/img/new_vote/logo.png">
    <div class="appText">
        <p class="appTitle">下载提谱旅行APP</p>
        <p class="appT">免费贴身导游，海量游玩贴士玩转全国景区。</p>
    </div>
    <a class="appDown" href="javascript:;">马上下载</a>
</div>

/* AppDownLoad */
.appD{display:none;position:fixed;top:0;left:0;width:100%;height:60px;background:#747E89;z-index:999}.appD .appLogo{width:40px;height:40px;padding:10px 0;float:left}.appD .appOff{float:left;width:20px;height:20px;margin:20px 10px;background:url(http://v2.jingqubao.com/apps/w3g/_static/img/new_vote/buttom_off.png) no-repeat;background-size:20px 20px}.appD .appDown{position:absolute;color:#FFF;background:#FFD700;width:74px;height:24px;margin:16px 5px;font-size:12px;line-height:24px;text-align:center;display:inline-block;border:2px solid #FFF;border-radius:60px;right:0;top:0}.appD .appText{color:#FFF;padding:9px 0;margin-left:90px;margin-right:88px;font-size:12px}.appD .appText .appTitle{font-size:16px}.appD .appText .appT{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}
