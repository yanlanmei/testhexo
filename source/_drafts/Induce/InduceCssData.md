...
拓展阅读：[那些年一起清除过的浮动](http://www.cnblogs.com/lhb25/p/story-of-clear-float.html)
认识圣杯布局和双飞翼布局
...
<!--This is a comment-->　　而只有IE可读的IE条件注释是：<!--[if IE]> <![endif]-->　　“非IE条件注释”：<!--[if !IE]>--> non-IE HTML Code <!--<![endif]-->　　“非特定版本IE条件注释”（很少用到）：<!--[if ! lt IE 7]><![IGNORE[--><![IGNORE[]]>Code for browsers that match the if condition<!--<![endif]-->
